...
<html>
    ...
    max-height: 82vh;
        ...
        $query = $conn->query("SELECT * FROM movie WHERE iswallpaper=1");
       ...
       if($num_rows>0){
        ...
        ?>
												<div class="
													...
													<a href=\"MovieDetails.php?Movie_id=".$row["ID"]."\">
														<img class=\"slideIMG\" src='".$row['wallpaper']."'>
														</a>"; ?>
													</div>
													<?php
            }}
        ?>
												...
												<a class="left carousel-control" href="#myCarousel" data-slide="prev" >
													<span class="glyphicon glyphicon-chevron-left"  style="margin-left: -42%;"></span>
													<span class="sr-only"  >Previous</span>
												</a>
												<a class="right carousel-control" href="#myCarousel" data-slide="next">
													<span class="glyphicon glyphicon-chevron-right" style="margin-right: -42%"></span>
													<span class="sr-only">Next</span>
												</a>
											</div>
										</div>
										<div style="padding-bottom: 1%;">
											<h3 style="display: inline-block;  margin-top: 5%; padding-Left:6%; color: white">Most Popular
 </h3>
											<span style="display: inline-block; font-size:25px; top: 5px; color: white" class="glyphicon glyphicon-chevron-right" ></span>
										</div>
										<div id="MovieList" class="row list-group">
											<?php


                                  $query = $conn->query("SELECT * FROM movie LIMIT 12");
                                  if ($query->num_rows > 0) {
                                      while ($row = $query->fetch_assoc()) {
																	...
																	<input  class="formInput" id="usernameLogin" type="text" placeholder="Enter Username"  required>
																		...
																		<input class="formInput" id="pwdLogin" type="password" placeholder="Enter Password" required>
																			...
																			<div class="formContainer" style="background-color:#f1f1f1">
																				...
																				<span class="psw">Already
																					<a style="cursor:pointer;" onclick="document.getElementById('id01').style.display = 'none';document.getElementById('id02').style.display = 'block'">registered?</a>
																				</span>
																			</div>
																		</form>
																	</div>
																				...
																				<input  class="formInput" id="usernameRegister" type="text" placeholder="Enter Username"  required>
																					...
																					<input class="formInput" id="pwdRegister" type="password" placeholder="Enter Password"  required>
																						...
																						<div class="formContainer" style="background-color:#f1f1f1">
																							...
																							<span class="psw">Already
																								<a style="cursor:pointer;" onclick="document.getElementById('id02').style.display = 'none';document.getElementById('id01').style.display = 'block'">Registered?</a>
																							</span>
																						</div>
																					</form>
																				</div>
